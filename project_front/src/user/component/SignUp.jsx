                            ...
                            <div className="login_part_form_iner">
                                ...
                                <form className="row contact_form" action="#" method="post" novalidate="novalidate">
                                    <div className="col-md-12 form-group p_star">
                                        <input type="text" className="form-control" id="email" name="email" value={data.email} placeholder="E-mail"
                                            onChange={changeData}/>
                                    </div>
                                    <div className="col-md-12 form-group p_star">
                                        <input type="text" className="form-control" id="user_name" name="user_name" value={data.user_name} placeholder="Name"
                                            onChange={changeData}/>
                                    </div>
                                    <div className="col-md-12 form-group p_star">
                                    ...
                                    <div className="col-md-12 form-group p_star">
                                        <input type="text" className="form-control" id="phone" name="phone" value={data.phone} placeholder="Phone-Number"
                                            onChange={changeData}/>
                                    </div>
                                    <div className="col-md-12 form-group p_star">
                                        <input type="text" className="form-control" id="address" name="address" value={data.address} placeholder="Address"
                                            onChange={changeData}/>
                                    </div>
