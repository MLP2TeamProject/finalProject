...
const SearchKeyword = () => {
    ...
    const paging = (group, pageNum) => {
        ...
        const serverData = resultList.slice((pageNum - 1) * perPageItemNum, (pageNum - 1) * perPageItemNum + perPageItemNum)
        let pageArray = []
                        ...
                        <nav className="justify-content-center d-flex mb-5">
                            <ul className="pagination">
                                <li className={pageState.currentPageGroup === 0 ? "page-item disabled" : "page-item"}>
                                    ...
                                    onClick={(e) => {
                                        e.preventDefault()
                                        onMoveGroup(pageState.currentPageGroup - 1, (pageState.currentPageGroup - 1) * perGroupPageNum +1)
                                        }}>
                                ...
                                <li className={pageState.pageArray[index] === pageState.currentPage ? "page-item active" : "page-item"} key={index}>
                                    <a href="#N" className="page-link" onClick={(e) => {
                                        e.preventDefault()
