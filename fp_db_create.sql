...
CREATE TABLE IF NOT EXISTS product ( -- 상품 보드
    ...
    endtime DATETIME NOT NULL, -- 경매 종료시간,프론트에서 +30일 해서 입력함
...
-- FOREIGN KEY (auction_id) REFERENCES auction(auction_id) -- FK
...
alter table product add foreign key (auction_id) references auction(auction_id);
